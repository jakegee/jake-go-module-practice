...
// RandomString returns a string of random characters of length n, using randomStringSource as the
...
// Slugify is a means of creating a slug from a string
...
// DownloadStaticFile downloads a file, and tries to force the brwoser to avoid displaying it in the browser
// window by setting content disposition. Also allows specification of the display name
